    ...
    <div className="min-h-screen bg-background scanline-overlay">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            <div className="md:col-span-3">
              <p className="text-base md:text-lg leading-relaxed text-foreground/80">
                {t(
                  'Racso Sami Cabrera Hernandez es bailarín, intérprete y creador escénico mexicano con formación en danza contemporánea, teatro físico y butoh. Estudió en la Escuela Profesional de Danza Contemporánea de Mazatlán y en SEAD — Salzburg Experimental Academy of Dance, Austria, de donde egresó en 2024. Ha colaborado con Teatro Cuerpo Social, compañía de danza-teatro y butoh en México, y desarrollado obra propia como intérprete-creador. Su pieza unipersonal Sabor Fresa ha sido su trabajo de mayor circulación. Se ha presentado en más de 20 festivales internacionales en México, Ecuador, Costa Rica, Austria, Francia, Bélgica y Reino Unido. AGENCIAS es su proyecto actual.',
                  "Racso Sami Cabrera Hernandez is a Mexican dancer, performer and stage creator with training in contemporary dance, physical theatre and butoh. He studied at the Escuela Profesional de Danza Contemporánea in Mazatlán and at SEAD — Salzburg Experimental Academy of Dance, Austria, from which he graduated in 2024. He has collaborated with Teatro Cuerpo Social, a dance-theatre and butoh company in Mexico, and developed his own work as a performer-creator. His solo piece Sabor Fresa has been his most widely performed work. He has presented at more than 20 international festivals across Mexico, Ecuador, Costa Rica, Austria, France, Belgium and the United Kingdom. AGENCIAS is his current project."
                )}
              </p>
            </div>
      ...
      <div className="py-14 px-6 text-center">
        <motion.a
          ...
          href="https://agencias-sistema.vercel.app/app/"
          target="_blank"
